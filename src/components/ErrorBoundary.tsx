      ...
      return (
        <div className="flex h-[80vh] w-full flex-col items-center justify-center p-4">
          <div className="flex max-w-md flex-col items-center text-center bg-card p-8 rounded-2xl shadow-sm border">
            ...
            <h1 className="text-2xl font-bold text-foreground mb-2">عذراً، حدث خطأ غير متوقع</h1>
            <p className="text-sm text-muted-foreground mb-6 line-clamp-3 leading-relaxed">
              {this.state.error?.message || "واجه التطبيق مشكلة أثناء عرض هذه الصفحة."}
            </p>
            <div className="flex gap-3">
              <Button onClick={() => window.location.reload()} className="gap-2">
                <RefreshCw className="h-4 w-4" /> تحديث الصفحة
              </Button>
